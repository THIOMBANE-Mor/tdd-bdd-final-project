...
class TestProductModel(unittest.TestCase):
    ...
    def test_deserialize_with_missing_data(self):
        ...
        with self.assertRaises(DataValidationError) as context:
            product.deserialize(data)
        self.assertTrue("missing name" in str(context.exception))

    def test_deserialize_with_invalid_boolean(self):
        """It should not Deserialize a Product with invalid boolean"""
        data = {
            "name": "Fedora",
            "description": "A red hat",
            "price": "12.50",
    ...
    def test_deserialize_with_none(self):
        """It should not Deserialize a Product with None as input"""
        product = Product()
        with self.assertRaises(DataValidationError) as context:
    ...
    def test_deserialize_with_empty_string(self):
        """It should not Deserialize a Product with an empty string as input"""
        product = Product()
        with self.assertRaises(DataValidationError) as context:
            product.deserialize("")
        self.assertTrue("Invalid product: body of request contained bad or no data" in str(context.exception))
    ...
    def test_deserialize_with_list(self):
        """It should not Deserialize a Product with a list as input"""
        product = Product()
        with self.assertRaises(DataValidationError) as context:
            product.deserialize([])
        self.assertTrue("Invalid product: body of request contained bad or no data" in str(context.exception))

    def test_deserialize_with_integer(self):
        """It should not Deserialize a Product with an integer as input"""
        product = Product()
        with self.assertRaises(DataValidationError) as context:
            product.deserialize(123)
        self.assertTrue("Invalid product: body of request contained bad or no data" in str(context.exception))
    ...
    def test_find_by_price(self):
        ...
        found = Product.find_by_price(str(price)).all()
        self.assertEqual(len(found), count)
        for product in found:
            self.assertEqual(product.price, price)
